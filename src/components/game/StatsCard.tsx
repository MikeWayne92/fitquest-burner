    ...
    <div className="glass-card space-y-4">
      ...
      <div>
        <div className="flex items-center justify-between mb-1">
          ...
          <span className="text-sm font-medium">{state.dailyCalories}/{state.dailyGoal}</span>
        </div>
        <Progress 
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-muted rounded-lg p-3">
          <div className="flex items-center text-orange mb-1">
            ...
            <h4 className="text-sm font-medium">Total Calories</h4>
          </div>
          <p className="text-xl font-bold">{state.player.calories}</p>
        </div>
        
        <div className="bg-muted rounded-lg p-3">
          <div className="flex items-center text-green mb-1">
            <Trophy className="w-4 h-4 mr-1" />
            <h4 className="text-sm font-medium">Quests Done</h4>
          </div>
          <p className="text-xl font-bold">{state.questsCompleted}</p>
        </div>
      </div>
    </div>
  );
